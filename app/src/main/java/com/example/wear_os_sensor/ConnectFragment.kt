...
class ConnectFragment : Fragment() {
        ...
        override fun onReceive(context: Context?, intent: Intent?) {
            if (intent?.action == "com.example.ACTION_SERVICE_STOPPED") {
                ...
                if(intent.hasExtra("state")){
                    ...
                    Toast.makeText(requireContext(), "Please start mobile app", Toast.LENGTH_SHORT).show()
                    return
                }
    ...
    private fun isLocationServiceRunning(): Boolean {
        val activityManager = requireActivity().getSystemService(ACTIVITY_SERVICE) as ActivityManager
